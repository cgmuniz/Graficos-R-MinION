...
dadosH <- read.csv("/home/administrator/Documentos/MinION/tabelas/MINCOV_comp_Heavy.csv", header = TRUE, sep = "\t")
...
dadosL <- read.csv("/home/administrator/Documentos/MinION/tabelas/MINCOV_comp_Light.csv", header = TRUE, sep = "\t")
